...
/// <reference name="System.Web.UI.HtmlControls.TextBox.js" assembly="System.Web.UI.HtmlControls.TextBox" />
...
System.Web.UI.HtmlControls.TextBox.CommandLine = function(input, context){
	...
	function createInterface(input){
		// Set objects.
		this.LineNode = this.Context.getElementById(input.id);
	...
	function LineNode_KeyDown(sender, e){
		...
		switch(keyCode){
			case 13: // [Enter]
				...
				var e = new System.EventArgs("Command");
				e["Command"] = this.LineNode.value;
				this.LineNode.value = "";
				this.RiseEvent(e);
				break;
			case 38: // [KeyUp]
