...
/// <reference name="System.Web.UI.HtmlControls.js" assembly="System.Web.UI.HtmlControls" />
...
System.Web.UI.HtmlControls = System.Web.UI.HtmlControls ? System.Web.UI.HtmlControls : {}
...
System.Web.UI.HtmlControls.DataBinder = function(){
	...
	this.DataQuery = new String;
	this.DataMember = new String;
	this.DataTextField = new String;
	this.DataValueField = new String;
	...
	this.onDataReady = function(sender, e){
		...
		if (nodeType == "string"){
			...
			var items = data.selectNodes(pathInformation);
			if (items.length > 0){
				var value = System.Xml.Node.parseString(items[0].selectSingleNode("text()"));
			...
			if (data == null){
				...
				if (dataSet.length > 0){
					...
					if (tables.length > 0){
						...
						var e = new System.EventArgs("OnError");
						e["Message"] = "DataSet does not contain tables";
						me.RiseEvent(e);
					}
				} else {
					var e = new System.EventArgs("OnError");
					e["Message"] = "DataSet is empty";
					me.RiseEvent(e);
				}
			}
		}
