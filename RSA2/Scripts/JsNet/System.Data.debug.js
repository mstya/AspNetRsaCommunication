...
/// <reference name="System.Data.js" assembly="System.Data" />
//=============================================================================
// Namespaces
//-----------------------------------------------------------------------------
// <PropertyGroup>
...
System.Data.Client = function(connectionString){
	...
	this.recordsAffected = new Number;
	this.ColumnsCount = new Number;
	this.RowsCount = new Number;
	this.ErrorMessage = new String;
	this.ParameterOutputName = new String;
	this.ConnectionMode;
	//---------------------------------------------------------
	// METHOD: Connect
	//---------------------------------------------------------
	...
	this.GetParametersListForCode = function(valIncludeOld, classNamespace, useNumbers, connectionStringInside){
		if (this.Command.Parameters.Count == 0){
			...
			var parameterValuesDebug = new String;
			var parametersSet = new String;
			// We will generate 5 parts of code.
			var stringFunctionParam = new String;
			var stringTraceMessages = new String;
